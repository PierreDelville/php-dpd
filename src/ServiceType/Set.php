...
class Set extends AbstractSoapClientBase
{
     ...
     * @param \Dpd\StructType\SetAlive $parameters
     * @return \Dpd\StructType\SetAliveResponse|bool
     */
    public function setAlive(\Dpd\StructType\SetAlive $parameters)
    {
        try {
            $this->setResult($this->getSoapClient()->setAlive($parameters));
     ...
     * @return \Dpd\StructType\SetAliveResponse
     */
