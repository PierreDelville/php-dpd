...
class Set extends AbstractSoapClientBase
{
     ...
     * @param \StructType\SetAlive $parameters
     * @return \StructType\SetAliveResponse|bool
     */
    public function setAlive(\StructType\SetAlive $parameters)
    {
        try {
     ...
     * @return \StructType\SetAliveResponse
     */
