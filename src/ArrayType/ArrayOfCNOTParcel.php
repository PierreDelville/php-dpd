...
class ArrayOfCNOTParcel extends AbstractStructArrayBase
{
     ...
     * @return \StructType\CNOTParcel[]|null
     */
    ...
    public static function validateCNOTParcelForArrayConstraintsFromSetCNOTParcel(array $values = array())
    {
        ...
        foreach ($values as $arrayOfCNOTParcelCNOTParcelItem) {
            ...
            if (!$arrayOfCNOTParcelCNOTParcelItem instanceof \StructType\CNOTParcel) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The CNOTParcel property can only contain items of type \StructType\CNOTParcel, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @param \StructType\CNOTParcel[] $cNOTParcel
     * @return \ArrayType\ArrayOfCNOTParcel
     */
     ...
     * @throws \InvalidArgumentException
     * @param \StructType\CNOTParcel $item
     * @return \ArrayType\ArrayOfCNOTParcel
     */
    public function addToCNOTParcel(\StructType\CNOTParcel $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\CNOTParcel) {
            throw new \InvalidArgumentException(sprintf('The CNOTParcel property can only contain items of type \StructType\CNOTParcel, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
